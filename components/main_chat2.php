                        ...
                        <div class="col-6 col-xl-6">
                            <div class="media text-center text-xl-left">
                                ...
                                <div class="media-body align-self-center text-truncate">
                                    <h6 class="text-truncate mb-n1">Carlos Swift</h6>
                ...
                <div class="container-xxl py-6 py-lg-10">
                    ...
                    <div class="message">
                        <a class="avatar avatar-sm mr-4 mr-lg-5" href="#" data-chat-sidebar-toggle="#chat-2-info">
                            <img class="avatar-img" src="https://randomuser.me/api/portraits/men/0.jpg" alt="">
                        </a>
                    ...
                    <div class="message message-right">
                        <div class="avatar avatar-sm ml-4 ml-lg-5 d-none d-lg-block">
                            <img class="avatar-img" src="https://randomuser.me/api/portraits/men/86.jpg" alt="">
                        </div>
                        <div class="message-body">
                            <div class="message-row">
                                <div class="d-flex align-items-center justify-content-end">
                                    <div class="message-content bg-primary text-white">
                                        <div>Hi, im fine and you?</div>       
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="message-content bg-light w-100">
                                        <div class="form-row py-3">
                                            <div class="col">
                                                <img class="img-fluid rounded" src="https://randomuser.me/api/portraits/women/26.jpg" data-action="zoom" alt="">
                                            </div>
                                            <div class="col">
                                                <img class="img-fluid rounded" src="https://randomuser.me/api/portraits/women/22.jpg" data-action="zoom" alt="">
                                            </div>
                                            <div class="col">
                                                <img class="img-fluid rounded" src="https://randomuser.me/api/portraits/women/12.jpg" data-action="zoom" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="message message-right">
                        ...
                        <div class="message-body">
                            <div class="message-row">
                                <div class="d-flex align-items-center justify-content-end">
                                    <div class="message-content bg-primary text-white">
                                        <div>Great they are beautiful</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="message">
                        ...
                        <div class="message-body">
                            <div class="message-row">
                                <div class="d-flex align-items-center">
                                    <div class="message-content bg-light">
                                        <div>We have to pack up and go somewhere one day</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="message">
                        ...
                        <div class="message-body">
                            <div class="message-row">
                                <div class="d-flex align-items-center">
                                    <div class="message-content bg-light">
                                        <div>Carlos печатает<span class="typing-dots"><span>.</span><span>.</span><span>.</span></span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
